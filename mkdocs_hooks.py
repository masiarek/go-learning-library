...
NAV_ORDER: dict[str, list[str]] = {
    "": [
        ...
        # The advanced language, after the concurrency it is best known for.
        "09_Generics",
        "10_Iterators",
        "11_Interfaces_and_Method_Sets",
        "12_Errors",
        "13_Defer_Panic_and_Recover",
        "14_Memory_and_the_Runtime",
        "15_Performance",
        "16_Reflection_and_Unsafe",
        "17_Build_and_Toolchain",
        "18_Testing",
        # Resources keeps its folder number (a URL) and moves to the end of the sidebar.
        "08_Resources",
    ],
    ...
    # Constraints first, then the two limits people hit (no generic methods, inference only from arguments), then a generic type and the type-set view that explains the rest.
    "09_Generics": [
        "README.md",
        "a_type_parameter_needs_a_constraint",
        "a_method_cannot_have_type_parameters",
        "inference_works_from_arguments_not_results",
        "a_generic_type_and_its_zero_value",
        "constraints_are_type_sets",
        "generics_compiler_errors",
        "generics_vet_and_lints",
        "generics_resources",
    ],
    # The mechanism, what break does to it, laziness, the pull adapter, and the standard library's iterators last, once the reader can write one.
    "10_Iterators": [
        "README.md",
        "range_over_a_function",
        "break_makes_yield_return_false",
        "an_iterator_is_lazy",
        "iter_pull_needs_its_stop",
        "slices_and_maps_have_iterators",
        "iterators_compiler_errors",
        "iterators_vet_and_lints",
        "iterators_resources",
    ],
    # Method sets, then embedding, then the two run-time surprises (a typed nil, the two-word layout), and assertions last.
    "11_Interfaces_and_Method_Sets": [
        "README.md",
        "a_pointer_receiver_changes_the_method_set",
        "embedding_is_not_inheritance",
        "a_nil_pointer_in_an_interface_is_not_nil",
        "an_interface_is_two_words",
        "type_switches_and_assertions",
        "interfaces_compiler_errors",
        "interfaces_vet_and_lints",
        "interfaces_resources",
    ],
    # Wrap and Is, then As, then trees of errors, then writing an error type of your own.
    "12_Errors": [
        "README.md",
        "wrap_with_w_unwrap_with_is",
        "errors_as_finds_a_type_in_the_chain",
        "errors_join_holds_many",
        "an_error_type_with_unwrap",
        "errors_compiler_errors",
        "errors_vet_and_lints",
        "errors_resources",
    ],
    # When arguments are evaluated, in what order defers run, what a defer may change, where recover works, and the loop mistake.
    "13_Defer_Panic_and_Recover": [
        "README.md",
        "defer_evaluates_its_arguments_now",
        "deferred_calls_run_last_in_first_out",
        "a_defer_can_change_a_named_result",
        "recover_only_in_the_deferred_call_itself",
        "defer_in_a_loop_runs_at_function_end",
        "defer_compiler_errors",
        "defer_vet_and_lints",
        "defer_resources",
    ],
    # Where a value lives, how big it is, how a stack grows, how the collector is tuned, and what runs after the last reference.
    "14_Memory_and_the_Runtime": [
        "README.md",
        "escape_analysis_decides_stack_or_heap",
        "struct_layout_and_padding",
        "a_goroutine_stack_grows_and_has_a_limit",
        "gogc_and_gomemlimit_tune_the_collector",
        "a_cleanup_runs_after_the_last_reference",
        "memory_compiler_errors",
        "memory_vet_and_lints",
        "memory_resources",
    ],
    # What a benchmark may record, counting allocations, then the three compiler lenses (inlining, bounds checks) and the profiler.
    "15_Performance": [
        "README.md",
        "allocs_per_op_is_a_key_ns_per_op_is_not",
        "allocsperrun_counts_allocations",
        "the_compiler_says_what_it_inlines",
        "bounds_checks_and_how_to_drop_them",
        "a_cpu_profile_names_the_hot_function",
        "performance_compiler_errors",
        "performance_vet_and_lints",
        "performance_resources",
    ],
    # Reading, then writing, through reflect; select over run-time cases; unsafe's rules; and what reflection costs.
    "16_Reflection_and_Unsafe": [
        "README.md",
        "reflect_reads_struct_tags",
        "reflect_sets_only_addressable_values",
        "reflect_select_over_cases_known_at_run_time",
        "unsafe_pointer_reinterprets_memory",
        "reflection_costs_allocations",
        "reflection_compiler_errors",
        "reflection_vet_and_lints",
        "reflection_resources",
    ],
    # Choosing files, embedding files, setting a variable at link time, generating files, and building the same binary twice.
    "17_Build_and_Toolchain": [
        "README.md",
        "build_constraints_choose_files",
        "go_embed_puts_files_in_the_binary",
        "ldflags_x_sets_a_variable_at_link_time",
        "go_generate_runs_a_command",
        "builds_are_reproducible",
        "build_compiler_errors",
        "build_vet_and_lints",
        "build_resources",
    ],
    # Subtests, example tests, parallel tests and cleanup, fuzzing, then coverage and the flags that select tests.
    "18_Testing": [
        "README.md",
        "subtests_and_table_tests",
        "an_example_test_checks_its_output",
        "t_parallel_and_t_cleanup",
        "fuzzing_finds_the_input_you_did_not_write",
        "coverage_and_the_run_flag",
        "testing_compiler_errors",
        "testing_vet_and_lints",
        "testing_resources",
    ],
}
